...
3. **Supersede RFC 6454 for origin.** The standard defines [[url-concepts|origin]] itself rather than deferring to [[rfc6454-overview|RFC 6454 ("The Web Origin Concept")]], giving origin a home inside the same living document as the parser that produces the URLs origins are computed from.
...
- [[rfc6454-overview]] — the superseded RFC itself
